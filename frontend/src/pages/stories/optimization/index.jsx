      ...
      <PageContainer>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-900 p-4">
            ...
            <div className="text-2xl font-bold text-gray-200">{avg_latency_formatted}</div>
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-900 p-4">
            ...
            <div className="text-2xl font-bold text-gray-200">{total_cost_formatted}</div>
            <div className="text-xs text-gray-500 mt-1">Last 7 days</div>
          </div>

          <div className="rounded-lg border border-gray-700 bg-gray-900 p-4">
            <div className="text-xs text-gray-500 uppercase tracking-wide mb-1">Avg Quality</div>
            <div className="text-2xl font-bold text-gray-200">{avg_quality_formatted}</div>
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-900 p-4">
            ...
            <div className="text-2xl font-bold text-gray-200">{cache_hit_rate_formatted}</div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="rounded-lg border border-green-900/50 bg-green-950/20 p-4">
            <div className="text-xs text-green-600 uppercase tracking-wide mb-1">Progress</div>
            <div className={`text-2xl font-bold ${theme.text}`}>{progress_pct.toFixed(0)}%</div>
            <div className="text-xs text-gray-500 mt-1">{complete_stories} of {total_stories} stories</div>
          </div>

          <div className="rounded-lg border border-green-900/50 bg-green-950/20 p-4">
            <div className="text-xs text-green-600 uppercase tracking-wide mb-1">Cost Saved</div>
            <div className={`text-2xl font-bold ${theme.text}`}>{total_cost_saved_formatted}</div>
            <div className="text-xs text-gray-500 mt-1">From completed fixes</div>
          </div>

          <div className="rounded-lg border border-green-900/50 bg-green-950/20 p-4">
            <div className="text-xs text-green-600 uppercase tracking-wide mb-1">Latency Saved</div>
            <div className={`text-2xl font-bold ${theme.text}`}>{total_latency_saved_formatted}</div>
            <div className="text-xs text-gray-500 mt-1">Per call improvement</div>
          </div>
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-900 p-4">
            ...
            <div className="text-xs text-gray-500 mt-1">Stories to optimize</div>
          </div>
        </div>
